...
# Performance counter service ports for different components
  ...
  ZAMA_PPXY_VIRT_HOSTS=("172.21.164.130" "172.21.164.137" "172.21.164.138" "172.21.164.139")
  ...
  ZAMA_PRTB_URI_HOSTNAME="rtb-pbm.bidder9.mookie1.com"
  ...
  ZAMA_PMTCH_URI_HOSTNAME="matcher.bidder9.mookie1.com"
...
# ZAMA_VDB_CONFIG_FILE=""
  ...
  ZAMA_PRESS_AUTO_NEGATE_SEGMENT_LIST='auto_negate_segment_list="20080343"'
