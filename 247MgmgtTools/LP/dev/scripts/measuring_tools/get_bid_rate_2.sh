...
for x in ${b[@]} ; do echo -e "===== $x" ;                                                             \
  ...
  {                                                                                                    \
    ...
    nr = a_nr+c_nr+e_nr+f_nr+g_nr+m_nr+p_nr+r_nr;                                                                          \
    t  = a_t+c_t+e_t+f_t+g_t+m_t+p_t+r_t;                                                                                 \
    bd = a_bd+c_bd+e_bd+f_bd+g_bd+m_bd+p_bd+r_bd;                                                                          \
    pd = a_pd+c_pd+e_pd+f_pd+g_pd+m_pd+p_pd+r_pd;                                                                          \
    e  = a_e+c_e+e_e+f_e+g_e+m_e+p_e+r_e;                                                                                 \
    nb = a_nb+c_nb+e_nb+f_nb+g_nb+m_nb+p_nb+r_nb;                                                                          \
    sz = a_sz+c_sz+e_sz+f_sz+g_sz+m_sz+p_sz+r_sz;                                                                          \
    nbsz = a_nbsz+c_nbsz+e_nbsz+f_nbsz+g_nbsz+m_nbsz+p_nbsz+r_nbsz;                                                          \
