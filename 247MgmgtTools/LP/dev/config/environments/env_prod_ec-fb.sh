...
# Performance counter service ports for different components (default (DPP) - 8801)
  ...
  ZAMA_TRACKER_COMMON_PHYS_HOSTS=("10.73.44.103" "10.73.44.104" "10.73.44.215" "10.73.44.222" "10.73.44.229" "10.73.44.236" "10.73.44.243" "10.73.44.250")
  ZAMA_TRACKER_FB_PHYS_HOSTS=("10.70.12.20" "10.70.12.30" "10.70.12.40" "10.70.12.50")
  ZAMA_TRACKER_PHYS_HOSTS=(${ZAMA_TRACKER_COMMON_PHYS_HOSTS[@]} ${ZAMA_TRACKER_FB_PHYS_HOSTS[@]})

  ZAMA_GPXY_PHYS_HOSTS=(${ZAMA_TRACKER_COMMON_PHYS_HOSTS[@]} "10.73.44.10" "10.73.44.21" "10.73.43.140" "10.73.43.150" "10.73.43.31" "10.73.43.41" "10.73.43.51" "10.73.43.61" "10.73.43.71" "10.73.43.81" "10.73.43.110" "10.73.43.120" "10.73.43.100" "10.73.43.130")
  ...
  ZAMA_FPXY_PHYS_HOSTS=(${ZAMA_TRACKER_FB_PHYS_HOSTS[@]})
  ZAMA_FPXY_VIRT_HOSTS=("10.70.12.201" "10.70.12.201" "10.70.12.201" "10.70.12.201")
...
#  ZAMA_YPXY_VIRT_HOSTS=("10.73.44.120" "10.73.44.121" "10.73.44.221" "10.73.44.228" "10.73.44.235" "10.73.44.242" "10.73.44.249" "10.73.44.56" "10.73.44.18"  "10.73.44.60" "10.73.43.37" "10.73.43.143" "10.73.43.153" "10.73.43.47" "10.73.43.57" "10.73.43.67" "10.73.43.77" "10.73.43.87" "10.73.43.113" "10.73.43.123" "10.73.43.106" "10.73.43.133")
  ...
  ZAMA_OPXY_VIRT_HOSTS=("10.73.44.124" "10.73.44.129" "10.73.44.140" "10.73.44.141" "10.73.44.155" "10.73.44.156" "10.73.44.8" "10.73.44.9" "10.73.44.18" "10.73.44.60" "10.73.43.165" "10.73.43.166" "10.73.43.167" "10.73.43.168" "10.73.43.169" "10.73.43.170" "10.73.43.171" "10.73.43.172" "10.73.43.173" "10.73.43.174" "127.0.0.1" "127.0.0.1")

  ZAMA_TRACKER_COMMON_VIRT_HOSTS=("10.73.44.110" "10.73.44.113" "10.73.44.216" "10.73.44.223" "10.73.44.230" "10.73.44.237" "10.73.44.244" "10.73.44.51")
  ZAMA_TRACKER_FB_VIRT_HOSTS=("10.70.12.21" "10.70.12.31" "10.70.12.41" "10.70.12.51")
  ZAMA_TRACKER_VIRT_HOSTS=(${ZAMA_TRACKER_COMMON_VIRT_HOSTS[@]} ${ZAMA_TRACKER_FB_VIRT_HOSTS[@]})

  ZAMA_CLK_TRACKER_PHYS_HOSTS=(${ZAMA_TRACKER_COMMON_PHYS_HOSTS[@]} ${ZAMA_TRACKER_FB_PHYS_HOSTS[@]})
  ZAMA_CLK_TRACKER_COMMON_VIRT_HOSTS=("10.73.44.116" "10.73.44.117" "10.73.44.219" "10.73.44.226" "10.73.44.233" "10.73.44.240" "10.73.44.247" "10.73.44.54")
  ZAMA_CLK_TRACKER_FB_VIRT_HOSTS=("10.70.12.23" "10.70.12.33" "10.70.12.43" "10.70.12.53")
  ZAMA_CLK_TRACKER_VIRT_HOSTS=(${ZAMA_CLK_TRACKER_COMMON_VIRT_HOSTS[@]} ${ZAMA_CLK_TRACKER_FB_VIRT_HOSTS[@]})

  ZAMA_CNV_TRACKER_PHYS_HOSTS=(${ZAMA_TRACKER_COMMON_PHYS_HOSTS[@]})
  ...
  ZAMA_MATCHER_PHYS_HOSTS=(${ZAMA_TRACKER_COMMON_PHYS_HOSTS[@]} ${ZAMA_TRACKER_FB_PHYS_HOSTS[@]})
  ZAMA_MATCHER_COMMON_VIRT_HOSTS=("10.73.44.111" "10.73.44.114" "10.73.44.217" "10.73.44.224" "10.73.44.231" "10.73.44.238" "10.73.44.245" "10.73.44.52")
  ZAMA_MATCHER_FB_VIRT_HOSTS=("10.70.12.22" "10.70.12.32" "10.70.12.42" "10.70.12.52")
  ZAMA_MATCHER_VIRT_HOSTS=(${ZAMA_MATCHER_COMMON_VIRT_HOSTS[@]} ${ZAMA_MATCHER_FB_VIRT_HOSTS[@]})

  ZAMA_APIPXY_PHYS_HOSTS=(${ZAMA_TRACKER_COMMON_PHYS_HOSTS[@]})
  ...
  ZAMA_FRTB_URI_HOSTNAME="rtb-fb.bidder7.mookie1.com"
...
#  ZAMA_YRTB_URI_HOSTNAME="rtb-rmx.bidder7.mookie1.com"
  ...
  ZAMA_ORTB_URI_HOSTNAME="rtb-opx.bidder7.mookie1.com"
  ...
  ZAMA_FTRK_URI_HOSTNAME="tracker-fb.bidder7.mookie1.com"
...
#  ZAMA_YTRK_URI_HOSTNAME=${ZAMA_GTRK_URI_HOSTNAME}
  ...
  ZAMA_CLTRK_FB_URI_HOSTNAME="tracker-clk-fb.bidder7.mookie1.com"
  ...
  ZAMA_FMTCH_URI_HOSTNAME="matcher-fb.bidder7.mookie1.com"
